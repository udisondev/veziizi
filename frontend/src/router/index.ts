...
const router = createRouter({
  ...
  // Back/forward (включая кнопку «Назад» через router.back()) восстанавливает
  // позицию скролла; обычная навигация — наверх страницы
  ...
  routes: [
    ...
    },
    {
      ...
      meta: { public: true, title: 'Подтверждение email' },
    },
